...
infile <- paste0("/net/snowwhite/home/beckandy/research/smaug-redux/summaries/chr", chr, "_full.singletons")
outfile <- paste0("/net/snowwhite/home/beckandy/research/singleton_case_control/data/chr", chr, "_sing_annotated.csv")
